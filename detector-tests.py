...
detectors = list(
    (
        ...
        (fast,"fast"),      # /10 # 4/10  0.0025038719177246094 0.0035512447357177734
        (gftt,"gftt"),      # /10 # 3/10  0.0755758285522461 0.029958724975585938
        (kaze,"kaze"), # To slow     # 5/10  1.1794540882110596 0.6536948680877686
        (mser,"mser"), # Blob ?
        (orb,"orb"),        # /10 # 2/10  0.011170148849487305 0.013445377349853516
        #(sbd,"sbd"), # WTF ? 1 Blob ?
        ...
        (star,"star"),      # /10 # 6/10  0.06461644172668457 0.022640228271484375
